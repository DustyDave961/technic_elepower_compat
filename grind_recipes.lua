...
local technic_grinding = {
	...
	{"basic_materials:brass_block",        "technic:brass_dust 9", time = 10},
	{"default:bronzeblock",	               "technic:bronze_dust 9", time = 10},
	{"elepower_dynamics:bronze_plate",     "technic:bronze_dust"},
	{"technic:carbon_steel_block",         "technic:carbon_steel_dust 9", time = 10},
	{"technic:chromium_block",             "technic:chromium_dust 9", time = 10},
	{"default:copperblock",      	       "technic:copper_dust 9", time = 10},
	{"elepower_dynamics:copper_plate",     "technic:copper_dust"},
	{"default:diamond",                    "elepower_dynamics:diamond_dust"},
	{"default:diamondblock",               "elepower_dynamics:diamond_dust 9", time = 10},
	...
	{"default:goldblock",                  "technic:gold_dust 9", time = 10},
	...
	{"elepower_dynamics:invar_block",      "elepower_dynamics:invar_dust 9", time = 10},
	...
	{"elepower_dynamics:lead_block",       "technic:lead_dust 9", time = 10},
	{"elepower_dynamics:lead_plate",       "technic:lead_dust"},
	{"default:mese",                       "default:mese_crystal 9", time = 10},
	{"default:mese_crystal",               "default:mese_crystal_fragment 9"},
	{"default:mese_crystal_fragment",      "elepower_dynamics:mese_dust", time = 1},
	{"moreores:mithril_block",             "technic:mithril_dust 9", time = 10},
	...
	{"elepower_dynamics:nickel_block",     "elepower_dynamics:nickel_dust 9", time = 10},
	{"elepower_dynamics:nickel_plate",     "elepower_dynamics:nickel_dust"},
	{"moreores:silver_block",              "technic:silver_dust 9", time = 10},
	{"elepower_dynamics:silver_plate",     "technic:silver_dust"},
	{"technic:stainless_steel_block",      "technic:stainless_steel_dust 9", time = 10},
	{"default:tinblock",                   "technic:tin_dust 9", time = 10},
	{"elepower_dynamics:tin_plate",	       "technic:tin_dust"},
	{"technic:uranium_block",              "technic:uranium_dust 9", time = 10},
	{"technic:uranium0_block",             "technic:uranium0_dust 9", time = 10},
	{"technic:uranium35_block", 	       "technic:uranium35_dust 9", time = 10},
	...
	{"elepower_dynamics:viridisium_block", "elepower_dynamics:viridisium_dust 9", time = 10},
	{"elepower_dynamics:viridisium_plate", "elepower_dynamics:viridisium_dust"},
	{"default:steelblock",	               "technic:wrought_iron_dust 9", time = 10},
	...
	{"elepower_dynamics:zinc_block",       "technic:zinc_dust 9", time = 10},
	{"elepower_dynamics:zinc_plate",       "technic:zinc_dust"},
	{"technic:zinc_block", 	               "technic:zinc_dust 9", time = 10},
	{"technic:lead_block", 	               "technic:lead_dust 9", time = 10},
}
...
for _, data in pairs(technic_grinding) do
	technic.register_grinder_recipe({input = {data[1]}, output = data[2], time = data.time or 3})
end
...
local elepower_grinding = {
	...
	{"technic:carbon_plate",              "technic:coal_dust 12", time = 16},
